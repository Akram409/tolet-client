...
export const CustomizeContent = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await axios.post("https://tolet-server-mu.vercel.app/api/about", {
        description,
      });
  ...
  const aboutData = async () => {
    try {
      const response = await axios.get(`https://tolet-server-mu.vercel.app/about`);
  ...
  const handleUpdate = async () => {
    try {
      ...
      const response = await axios.patch(
        `https://tolet-server-mu.vercel.app/about/${aboutInfo._id}`,
        {
  ...
  const handleSubmitMedia = async (e) => {
    ...
    try {
      ...
      const response = await fetch("https://tolet-server-mu.vercel.app/footer", {
        method: "POST",
        headers: {
  ...
  const handleUpdateMedia = async (e) => {
    ...
    try {
      ...
      const response = await fetch(`https://tolet-server-mu.vercel.app/footer/${footerId}`, {
        method: "PATCH",
        headers: {
          "Content-Type": "application/json",
        },
